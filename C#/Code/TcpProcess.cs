...
namespace C_.Code
{
    internal class TcpProcess
    {
        ...
        public struct ClientInfo
        {
            ...
            public StreamCommunicate Communicate; //my code in same folder
        }
        ...
        class Server
        {
            ...
            public async Task Listen() //use other thread while
            {
                ...
                info.Communicate = new StreamCommunicate(info.Stream);
                _clients.Add(info);
            }
        ...
        class Client
        {
            ...
            private StreamCommunicate _communicate;
            ...
            public async Task Connect()
            {
                ...
                _communicate = new StreamCommunicate(_stream);
            }
